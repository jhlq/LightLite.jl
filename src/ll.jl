...
examples["Toffoli"]="""Dict(:id=>"Emitter",:loc=>(-6, 0, 2),:dir=>(1, 0, 0),:pol=>[0, 1])
Dict(:id=>"Emitter",:loc=>(-6, 1, 2),:dir=>(1, 0, 0),:pol=>[0, 1])
Dict(:id=>"Emitter",:loc=>(-6, 2, 2),:dir=>(1, 0, 0),:pol=>[1, 0])
Dict(:id=>"H",:loc=>(-5, 2, 2))
Dict(:id=>"Mirror",:loc=>(-4, 2, 2),:vars=>[1])
Dict(:id=>"CNOT",:loc=>(-3, 1, 2))
Dict(:id=>"T†",:loc=>(-2, 0, 2))
Dict(:id=>"Mirror",:loc=>(-3, 0, 2),:vars=>[1])
Dict(:id=>"Mirror",:loc=>(-2, -1, 2),:vars=>[1])
Dict(:id=>"CNOT",:loc=>(-1, -1, 2))
Dict(:id=>"Mirror",:loc=>(0, -2, 2),:vars=>[1])
Dict(:id=>"Mirror",:loc=>(1, -2, 2),:vars=>[2])
Dict(:id=>"T",:loc=>(1, 0, 2))
Dict(:id=>"CNOT",:loc=>(1, 1, 2))
Dict(:id=>"T†",:loc=>(1, 2, 2))
Dict(:id=>"CNOT",:loc=>(3, -1, 2))
Dict(:id=>"Mirror",:loc=>(1, 3, 2),:vars=>[2])
Dict(:id=>"Mirror",:loc=>(2, 3, 2),:vars=>[1])
Dict(:id=>"Mirror",:loc=>(3, 2, 2),:vars=>[0])
Dict(:id=>"Mirror",:loc=>(4, 1, 2),:vars=>[1])
Dict(:id=>"Mirror",:loc=>(5, 0, 2),:vars=>[0])
Dict(:id=>"CNOT",:loc=>(6, -1, 2))
Dict(:id=>"Mirror",:loc=>(5, -3, 2),:vars=>[0])
Dict(:id=>"Mirror",:loc=>(6, -4, 2),:vars=>[1])
Dict(:id=>"Mirror",:loc=>(7, -4, 2),:vars=>[2])
Dict(:id=>"Mirror",:loc=>(7, -2, 2),:vars=>[3])
Dict(:id=>"T†",:loc=>(7, -3, 2))
Dict(:id=>"T",:loc=>(3, -5, 2))
Dict(:id=>"Mirror",:loc=>(3, -6, 2),:vars=>[2])
Dict(:id=>"H",:loc=>(2, -6, 2))
Dict(:id=>"T†",:loc=>(5, 1, 2))
Dict(:id=>"Mirror",:loc=>(7, -1, 2),:vars=>[-1])
Dict(:id=>"CNOT",:loc=>(7, 1, 2))
Dict(:id=>"Mirror",:loc=>(5, 2, 2),:vars=>[2])
Dict(:id=>"Mirror",:loc=>(6, 2, 2),:vars=>[1])
Dict(:id=>"S",:loc=>(9, -1, 2))
Dict(:id=>"T",:loc=>(7, 2, 2))
Dict(:id=>"Mirror",:loc=>(0, -6, 2),:vars=>[1])
Dict(:id=>"Measure",:loc=>(-5, -1, 2))"""
